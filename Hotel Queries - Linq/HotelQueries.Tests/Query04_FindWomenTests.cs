...
namespace iQuest.HotelQueries.Tests
{
    ...
    public class Query04_FindWomenTests
    {
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenStartTimeIsGreaterThanEndTime_ThenThrows()
        {
            Assert.ThrowsException<ArgumentException>(() =>
            {
                DateTime startTime = new DateTime(2015, 12, 31, 23, 59, 29);
                DateTime endTime = new DateTime(2015, 01, 01);

                hotel.FindWomen(startTime, endTime);
            });
        }

        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear200_ThenReturnsEmptyList()
        {
            DateTime startTime = new DateTime(2000, 01, 01);
            DateTime endTime = new DateTime(2000, 12, 31, 23, 59, 29);
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear2015_ThenReturnsCorrectList()
        {
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear2016_ThenReturnsCorrectList()
        {
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear2017_ThenReturnsCorrectList()
        {
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear2018_ThenReturnsCorrectList()
        {
        ...
        [TestMethod]
        public void HavingAHotelInstance_WhenSearchForWomenInYear2019_ThenReturnsCorrectList()
        {
